...
CREATE TABLE `like_record` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `like_num` (`like_num`),
  KEY `member_id` (`member_id`),
  CONSTRAINT `like_record_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`),
  CONSTRAINT `like_record_ibfk_2` FOREIGN KEY (`like_num`) REFERENCES `message` (`id`)
...
INSERT INTO `like_record` VALUES (1,1,5,'+1'),(2,2,3,'+1'),(3,3,2,'+1'),(4,4,1,'+1'),(5,5,4,'+1'),(6,1,6,'+1');
...
INSERT INTO `message` VALUES (1,5,'I AM GOOD GUY',50,'2022-10-18 21:13:23'),(2,2,'HAVE A NICE DAY',684,'2022-10-18 21:13:25'),(3,1,'LONG TIME NO SEE',987,'2022-10-18 21:13:27'),(4,4,'NICE TO MEET YOU',10,'2022-10-18 21:13:28'),(5,4,'hello',80,'2022-10-18 21:13:30'),(6,4,'how are you',10,'2022-10-18 21:13:31'),(7,4,'thanks',50,'2022-10-18 21:13:33');
...
-- Dump completed on 2022-10-18 21:24:52
